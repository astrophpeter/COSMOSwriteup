...
\section{Data}
   ...
   2MASS response curve from \cite{2mass2006}.
    ...
    Used rest frame U-V and V-J colours provided by \cite{muzzin2013public}
   These were calculated using the \textsc{EAZY} code \cite{eazycode}, and the errors obtained from the error template in this paper.
   Filters for the bands: U,V Johnson filtres from \cite{maiz2006}, J - 2Mass Filter from \cite{2mass2006}. 
